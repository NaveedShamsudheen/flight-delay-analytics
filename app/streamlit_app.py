...
fig1 = px.line(filtered, x="year_month", y="total_flights", title="Total Flights per Month")
fig2 = px.line(filtered, x="year_month", y="avg_arr_delay", title="Average Arrival Delay per Month")
fig3 = px.line(filtered, x="year_month", y="cancel_rate", title="Cancellation Rate per Month")
...
if "2020" in year_filter:
    st.markdown("🦠 **COVID Impact**: Flight activity collapsed in early 2020, then gradually recovered from 2021 onward.")
